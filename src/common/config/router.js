module.exports = [
  ...
  [/\/v1\/apps\/(\w+)\/comments\/(\d+)?/, '/api/v1/app/comments?appId=:1&id=:2', 'get'],
  [/\/v1\/apps\/(\w+)\/posts\/(\d+)\/replies?/, '/api/v1/app/posts/replies?appId=:1&id=:2', 'get'],
  [/\/v1\/apps\/(\w+)\/posts$/, '/api/v1/apps/posts?appId=:1', 'get'],

  // LIKES API
  [/\/v1\/apps\/(\w+)\/posts\/(\d+)\/(\w+)\/mine\/(\w+)?/, '/api/v1/app/posts/:3/mine?appId=:1&id=:2&action=:4', 'get, post'],
  [/\/v1\/apps\/(\w+)\/posts\/(\d+)\/(\w+)\/new?/, '/api/v1/app/posts/:3/new?appId=:1&id=:2', 'post'],
  [/\/v1\/apps\/(\w+)\/posts\/(\d+)\/likes?/, '/api/v1/app/posts/likes?appId=:1&id=:2', 'get'],
  [/\/v1\/apps\/(\w+)\/me\/likes?/, '/api/v1/app/me/likes?appId=:1', 'get'],
